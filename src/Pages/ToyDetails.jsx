                ...
                <div className="bg-base-200 min-h-screen flex flex-col items-center">
                    <div className="hero-content flex-col lg:flex-row">
                        ...
                        <div>
                            ...
                            <div className=''>
                                <p className='btn bg-secondary'><FaStar></FaStar> {toy.rating}</p>
                                <p className='btn bg-secondary'>
                                    <span>Left : </span>
                                    <span className='text-red-800 font-semibold'>{toy.availableQuantity}</span>
                                    <span>pc  only</span>
                                </p>
                                <h1 className="text-3xl font-bold mt-3">{toy.price} USD</h1>
                                <p className='my-3 font-semibold'>Seller Name : {toy.sellerName}</p>
                            </div>
                        </div>
                    </div>
                    <div className='w-1/3'>
                        <form onSubmit={handleSubmitBtn} className="card-body">
                            <fieldset className="fieldset">
                                ...
                                <div className='pl-25'>
                                    <button type='submit' className='btn btn-primary w-fit'>Try Now</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
